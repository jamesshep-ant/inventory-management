export default {
  ...
  restocking: {
    title: "補充発注",
    description: "予算を設定し、需要予測に基づく推奨補充数量を確認します",
    budgetCard: {
      title: "補充予算",
      selected: "選択予算",
      allocated: "割り当て済み",
    ...
    recommendations: {
      ...
      recommendedQty: "推奨数量",
      lineTotal: "小計",
      notCovered: "予算でカバーされません",
      empty: "現在補充が必要な品目はありません",
      dragHint: "行をドラッグして優先順位を変更",
      resetPriority: "優先順位をリセット",
    },
    placeOrder: "発注する",
